...
/** Metric tile for API telemetry (requests, latency, success rate, keys). */
export function APIStatCard({
  label, value, unit, icon: Icon, trend, trendLabel, tone = "default", footer, className,
}: {
  label: string;
  value: string | number;
  unit?: string;
